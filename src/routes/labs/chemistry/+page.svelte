...
<div class="min-h-screen">
	...
	<div class="mb-8">
		<div class="flex items-center gap-3 mb-2">
			...
			<div>
				<h1 class="text-3xl font-display font-bold text-white">Chemistry Labs</h1>
				<p class="text-gray-400">Explore chemical reactions and analytical techniques</p>
			</div>
		</div>
	</div>
	...
	<div class="grid md:grid-cols-2 gap-6">
		{#each labs as lab}
			...
			>
				...
				<!-- Card Body -->
				<div class="p-6">
					<h3 class="text-xl font-display font-semibold text-white mb-2 group-hover:text-cyan-400 transition-colors">
						{lab.title}
					</h3>
